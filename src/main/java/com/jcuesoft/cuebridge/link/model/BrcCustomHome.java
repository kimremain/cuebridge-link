...
/**
 * The persistent class for the BRC_CUSTOM_HOME database table.
 * 
 */
@Entity
@Table(name="BRC_CUSTOM_HOME")
@NamedQuery(name="BrcCustomHome.findAll", query="SELECT b FROM BrcCustomHome b")
public class BrcCustomHome implements Serializable {
