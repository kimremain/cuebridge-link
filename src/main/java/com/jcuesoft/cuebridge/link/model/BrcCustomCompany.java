...
/**
 * The persistent class for the BRC_CUSTOM_COMPANY database table.
 * 
 */
@Entity
@Table(name="BRC_CUSTOM_COMPANY")
@NamedQuery(name="BrcCustomCompany.findAll", query="SELECT b FROM BrcCustomCompany b")
public class BrcCustomCompany implements Serializable {
