...
/**
 * The persistent class for the BRC_CUSTOM database table.
 * 
 */
@Entity
@Table(name="BRC_CUSTOM")
@NamedQuery(name="BrcCustom.findAll", query="SELECT b FROM BrcCustom b")
public class BrcCustom implements Serializable {
