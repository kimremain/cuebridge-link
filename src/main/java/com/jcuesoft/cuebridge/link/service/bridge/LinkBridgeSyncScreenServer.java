 ...
 */
public class LinkBridgeSyncScreenServer {
    static int port;
    ...
    public static void main(String[] args) throws Exception {
        ...
        port = util.getHttpServicePort("bridge.syncscreen.port");
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new LinkBridgeSyncScreenServerInitializer(sslCtx));
