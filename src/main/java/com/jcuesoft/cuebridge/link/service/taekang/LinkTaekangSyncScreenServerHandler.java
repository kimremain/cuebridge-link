...
public class LinkTaekangSyncScreenServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    String callback;
    LinkTaekangSyncScreenService service;
    
    /** Buffer that stores the response content */
    private final StringBuilder buf = new StringBuilder();
    
    public LinkTaekangSyncScreenServerHandler() throws Exception{
        System.out.println("LinkTaekangSyncScreenServerHandler init");
        callback = "Success";
        util = new UtilProperties();
        service = new LinkTaekangSyncScreenService();
