 ...
 */
public class LinkTaekangSyncScreenServer {
    static int port;
    ...
    public static void main(String[] args) throws Exception {
        ...
        port = util.getHttpServicePort("taekang.syncscreen.port");
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new LinkTaekangSyncScreenServerInitializer(sslCtx));
