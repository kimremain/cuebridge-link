 ...
 */
public class LinkYSMGroupSyncSafekeyServer {
    static int port;
    ...
    public static void main(String[] args) throws Exception {
        ...
        port = util.getHttpServicePort("ysmgroup.syncsafekey.port");
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new LinkYSMGroupSyncSafekeyServerInitializer(sslCtx));
