 ...
 */
public class LinkYSMGroupSyncScreenServer {
    static int port;
    ...
    public static void main(String[] args) throws Exception {
        ...
        port = util.getHttpServicePort("ysmgroup.syncscreen.port");
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new LinkYSMGroupSyncScreenServerInitializer(sslCtx));
