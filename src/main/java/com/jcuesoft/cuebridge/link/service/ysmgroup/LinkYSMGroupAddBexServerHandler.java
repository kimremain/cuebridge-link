...
public class LinkYSMGroupAddBexServerHandler extends SimpleChannelInboundHandler<Object> {

    private HttpRequest request;
    static UtilProperties util;
    static ModuleCommon mc;
    static LinkYSMGroupAddBexService service;
    String uri;
    String domain;
    String hostName;
    EntityManager em;
    ...
    public LinkYSMGroupAddBexServerHandler() throws Exception{
        System.out.println("LinkYSMGroupServerHandler init");
        callback = "Success";
        util = new UtilProperties();
        mc = new ModuleCommon();
        service = new LinkYSMGroupAddBexService();
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof HttpContent) {
            ...
            if (content.isReadable()) {
                ...
                if(uri.matches("(.*)addbex(.*)")){
                    /*==================================================================================
                     * addbex service post method start
                    ==================================================================================*/
                    callback = checkValidParamAddBex(paramMap);
                    System.out.println(callback);
                    if(!callback.substring(0,1).equals("F")){
                        //LinkYSMGroupService service = new LinkYSMGroupService();
                        callback = service.excuteBizAddBex(em, paramMap);
                        buf.append(callback);
                        buf.append("\r\n");
                    }
                    /*==================================================================================
                     * addbex service post method end
                    ==================================================================================*/                    
                }else{
                ...
                System.err.println("<Notice> readable contents");
            }
    ...
    private String checkValidParamAddBex(Map<String, String> param) {
        ...
        if(param.get("cd_company_ex") == null || param.get("cd_company_ex").equals("")){
            callback = "Fail: cd_company_ex parameter empty!";
            System.err.println(callback);
            buf.append(callback);
            buf.append("\r\n");
        }        
        if(param.get("nm_screen_path") == null || param.get("nm_screen_path").equals("")){
            callback = "Fail: nm_screen_path parameter empty!";
            System.err.println(callback);
            buf.append(callback);
            buf.append("\r\n");
        }
