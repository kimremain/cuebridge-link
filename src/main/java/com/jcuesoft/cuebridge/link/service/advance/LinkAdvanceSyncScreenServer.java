 ...
 */
public class LinkAdvanceSyncScreenServer {
    static int port;
    ...
    public static void main(String[] args) throws Exception {
        ...
        port = util.getHttpServicePort("advance.syncscreen.port");
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new LinkAdvanceSyncScreenServerInitializer(sslCtx));
